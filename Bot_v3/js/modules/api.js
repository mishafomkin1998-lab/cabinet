...
// ПРОЦЕСС: Синхронизация всех анкет одним запросом на LABABOT сервер
// ЗА ЧТО ОТВЕЧАЕТ: Отправляет статусы всех анкет, получает команды управления (вкл/выкл рассылки)
// НАГРУЗКА: ✅ ОПТИМАЛЬНО - один запрос каждые 10 минут вместо N heartbeat'ов
// МАСШТАБИРОВАНИЕ: При 3000 анкет = всего 6 запросов/час на LABABOT сервер
...
// ============= PROMPT SYNC (Синхронизация промпта AI) =============
// ПРОЦЕСС: Периодическая загрузка промпта для AI генерации с LABABOT сервера
// ЗА ЧТО ОТВЕЧАЕТ: Синхронизация промпта для генерации писем (настраивается в dashboard)
// НАГРУЗКА: ✅ ОПТИМАЛЬНО - один запрос каждые 5 минут
// МАСШТАБИРОВАНИЕ: Не зависит от количества анкет
