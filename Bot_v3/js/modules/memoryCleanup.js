...
// ПРОЦЕСС: Автоматическая очистка памяти при длительной работе
// ЗА ЧТО ОТВЕЧАЕТ: Предотвращение утечек памяти (hotQueue, freshOnline, conversations, WebView cache)
// НАГРУЗКА: ✅ Локально - никаких API запросов
// МАСШТАБИРОВАНИЕ: Критически важно при большом количестве анкет (95+)
