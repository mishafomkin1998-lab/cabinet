...
let defaultSettings = {
    ...
    // Отключенные статусы (пропускаются в авто-режиме) - раздельно для Mail и Chat
...
// НАГРУЗКА: Делает /api/users/online запрос к LadaDate для КАЖДОГО бота каждые 30 сек
// ПРИМЕЧАНИЕ: Запросы идут на LadaDate (сайт знакомств), НЕ на LABABOT сервер
const SharedPool = {
