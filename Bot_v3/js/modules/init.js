...
// ПРОЦЕСС: Обновление счётчика мужчин онлайн в интерфейсе
// ЗА ЧТО ОТВЕЧАЕТ: Отображает количество мужчин онлайн в header (число рядом с иконкой)
// НАГРУЗКА: ✅ ОПТИМАЛЬНО - только чтение локального кэша, БЕЗ API запросов
// МАСШТАБИРОВАНИЕ: Не влияет на нагрузку сервера
