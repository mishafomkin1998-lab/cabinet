        ...
        class AccountBot {
            ...
            async startMail(text) {
                ...
                if (controlStatus.panicMode) {
                    ...
                    this.log(`🚨 Panic Mode активен! Рассылка заблокирована.`);
                    return;
                }
            ...
            col4.innerHTML = `
                <div class="panel-col">
                    ...
                    <div class="bl-input-row">
                        ...
                        <button class="btn btn-outline-success btn-sm" onclick="addBlacklistFromInput('${bot.id}', true)" title="Добавить всем анкетам">All</button>
                    </div>
