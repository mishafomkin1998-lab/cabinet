// ==========================================
// ROUTES/STATS.JS - Все эндпоинты статистики
// Эндпоинты: /api/stats/detailed, /api/stats/daily, /api/stats/top-profiles,
//            /api/stats/translators, /api/stats/admins, /api/stats/profile/:id,
//            /api/stats/forecast, /api/stats/hourly-activity,
//            /api/stats/by-admin, /api/stats/by-translator
// ==========================================
...
router.get('/api/stats/top-profiles', async (req, res) => {
...
// GET /api/stats/translators - Статистика по переводчикам
router.get('/api/stats/translators', async (req, res) => {
    const { userId, role } = req.query;
    try {
        let filter = "";
        let params = [];
...
// GET /api/stats/admins - Статистика по админам (только для директора)
router.get('/api/stats/admins', async (req, res) => {
    const { userId, role } = req.query;
...
// GET /api/stats/profile/:profileId - Детальная статистика по анкете
router.get('/api/stats/profile/:profileId', async (req, res) => {
...
router.get('/api/stats/forecast', async (req, res) => {
    const { userId, role } = req.query;
    try {
        let filter = "";
        let params = [];
...
// GET /api/stats/hourly-activity - Активность по часам (тепловая карта)
router.get('/api/stats/hourly-activity', async (req, res) => {
    const { userId, role } = req.query;
...
router.get('/api/stats/by-admin', async (req, res) => {
...
router.get('/api/stats/by-translator', async (req, res) => {
