    ...
    ru: {
        ...
        history: {
            ...
            actions: {
                ...
                delete: 'Удалена',
                removed: 'Удалена',
                assign_admin: 'Назначен админ',
                unassign_admin: 'Снят админ',
                assign_translator: 'Назначен переводчик',
                unassign_translator: 'Снят переводчик',
                assigned: 'Назначена',
                unassigned: 'Снята',
    ...
    en: {
        ...
        history: {
            ...
            actions: {
                ...
                delete: 'Deleted',
                removed: 'Removed',
                assign_admin: 'Admin assigned',
                unassign_admin: 'Admin removed',
                assign_translator: 'Translator assigned',
                unassign_translator: 'Translator removed',
                assigned: 'Assigned',
    ...
    uk: {
        ...
        history: {
            ...
            actions: {
                ...
                delete: 'Видалена',
                removed: 'Видалена',
                assign_admin: 'Призначено адміна',
                unassign_admin: 'Знято адміна',
                assign_translator: 'Призначено перекладача',
                unassign_translator: 'Знято перекладача',
                assigned: 'Призначена',
                unassigned: 'Знята',
                paused: 'Призупинена',
                resumed: 'Відновлена',
